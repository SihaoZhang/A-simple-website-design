      ...
      <nav class="navbar navbar-inverse">
		...
		<div id="page-wrapper">
			<div class="main-page">
				...
				<h2 class="title1">New Job</h2>
				<div class="grids widget-shadow">
					<div class="form-group">
						<div class="row">
							<div class="col-md-12">
								Title: <br>
								<input type="text" class="form-control1"  name = "jtitle">
							</div>
							<div class="clearfix"> </div>
						</div>
					</div>
					<div class="form-group">
						<div class="row">
							<div class="col-md-12">
								Location: <br>
								<input type="text" class="form-control1" name = "jlocation">
							</div>
							<div class="clearfix"> </div>
						</div>
					</div>
					<div class="form-group">
						<div class="row">
							<div class="col-md-12">
								Salary: <br>
								<input type="text" class="form-control1" name = "salary">
							</div>
							<div class="clearfix"> </div>
						</div>
					</div>
					<div class="form-group">
						<div class="row">
							<div class="col-md-12">
								Academic Requirement(eg:"MS EE"): <br>
								<input type="text" class="form-control1" name = "req">
							</div>
							<div class="clearfix"> </div>
						</div>
					</div>
					<div class="form-group">
						<div class="row">
							<div class="col-md-12">
								Description: <br>
								<input type="text" rows = "2" class="form-control1" name = "description">
							</div>
							<div class="clearfix"> </div>
						</div>
					</div>
					<div class="form-group">
						<div class="row">
							<div class="col-md-12">
								Duedate: <br>
								<input type="date" value="<?php echo date("Y-m-d");?>" name = "duedate"/>
							</div>
							<div class="clearfix"> </div>
						</div>
					</div>
					<div class="sub_home">
						<input type="submit" value="Save & Post" name="Jobpost">
					</form>	
							<div class="clearfix"> </div>
					</div>
				</div>
