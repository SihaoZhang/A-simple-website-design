...
$_SESSION['fidm']=$fid;
$sql="select * from message 	where sid in (select sid from student where sid='$nowid' or sid ='$fid') and fid in (select sid from student where sid='$nowid' or sid ='$fid') and know =1 order by mtime desc";
			...
			<div class="main-page">
				...
				<div class="activity_box activity_box1">
					...
					while ($row=mysqli_fetch_array($rlt)){
						...
						$finish=sqlresult($update) or die ("wrong");
					?>
