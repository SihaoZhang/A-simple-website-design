...
$name=$row1['cname'];
$sql = "SELECT * FROM application natural join job natural join company natural join student WHERE cid = '$nowid'";
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="activity_box">
					...
					$_SESSION['jid'.$i] = $row['jid'];
					?>
			
						<div class="activity-row">
								<h1><?php echo $row['sname'];?></h1>
								<h4>Applied Job: <?php echo $row['jtitle'];?></h4>
								<h4>University: <?php echo $row['university'];?></h4>
								<h4>Status: <?php echo $row['status'];?></h4>

								<form action = "stu_applyjob.php" method = "post">
									<input type = "submit" value="Learn More"  name = "stu_applyjob<?php echo $i;?>">
								</form>					
						</div>
						<?php
						$i=$i+1;
