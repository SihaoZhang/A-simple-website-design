		...
		<div id="page-wrapper">
			<div class="main-page">
				...
				<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						...
						<div class="form-body">
							<form action="stuopen.php" method="post">
								<div class="form-group"> 
										Is your personal information open to the public?
										<div class="checkbox-inline1"><label><input type="checkbox" value = "yes" name = "yes" > Yes </label></div>
										<div class="checkbox-inline1"><label><input type="checkbox" value = "no" name = "no"> No </label></div>
								</div>
								<div class="form-group"> 
								<button type="submit" class="btn btn-default" name = "stuopen">Submit</button> 
								</div>
							</form> 
						</div>
				</div>
