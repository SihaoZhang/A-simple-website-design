...
$name=$row1['cname'];
$sql = "SELECT * FROM job AS j, company AS c WHERE j.cid = '$nowid' AND j.cid = c.cid";
					...
					?>
						...
						<div class="activity-row">
							<div class="col-xs-4 activity-desc">
								...
								<h4>Location: <?php echo $row['jlocation'];?></h4>
								<h4>Salary: <?php echo $row['salary'];?></h4>
								<h4>Academic Requirement: <?php echo $row['req'];?></h4>
								<h4>Due Date: <?php echo $row['duedate'];?></h4>
							</div>
							<div class="col-xs-8 activity-desc1">
								<form action = "jobupdate.php" method="post">
								<h5><input type="submit" name="job<?php echo $i?>" value="UPDATE"/></h5>
								</form>
								<form action = "jobpush.php" method="post">
								<h5><input type="submit" name="job<?php echo $i?>" value="Push Selected"/></h5>
								</form>
								<form action = "pushinsert.php" method="post">
									<h5><input type="submit" name="job<?php echo $i?>" value="Push to Followers"/></h5>
								</form>
							</div>							
							<div class="clearfix"> </div>
						</div>
