				...
				<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						...
						<div class="form-body">
							<form action="pwdupdate.php" method="post">
								...
								<div class="form-group"> 
									<label for="exampleInputPassword1">Confirm Password(Please keep same with above type-in)</label> 
									<input type="password" name="pwdconfirm" placeholder="reinsert password" class="form-control"> 
								</div> 
								<div class="form-group"> </div> 
								<button type="submit" class="btn btn-default" name = "stu_pwdupdate">Submit</button> 
							</form> 
						</div>
				</div>
