      ...
      <nav class="navbar navbar-inverse">
		...
		<!-- //header-ends -->
			...
			<div class="main-page general">
				<h2 class="title1"><?php echo $row1['cname']; ?></h2>
				<div class="panel-info widget-shadow">
					<div class="col-md-6 panel-grids">
						<div class="panel panel-primary"> <div class="panel-heading"> <h3 class="panel-title">Location</h3> </div> <div class="panel-body"><?php echo $row1['clocation'];?></div> </div>
					</div>
					<div class="col-md-6 panel-grids">
						<div class="panel panel-success"> <div class="panel-heading"> <h3 class="panel-title">Industry</h3> </div> <div class="panel-body"><?php echo $row1['industry'];?></div> </div>
					</div>
					<div class="clearfix"> </div>
				</div>

				<div class="sub_home">
					<form action = "comedit.php" method="post">
