      ...
      <nav class="navbar navbar-inverse">
		...
		<div id="page-wrapper">
			<div class="main-page">
				...
				<h2 class="title1">Push Select</h2>
				<div class="grids widget-shadow">
							...
							<div class="col-md-12">
								Name:
									<select name="University">
										<option value="">No specific demand</option>
						...
						<div class="row">
							<div class="col-md-12">
								...
								<select name="Major">
									...
									<option value="CE">CS</option>
									<option value="MFE">EE</option>
								</select>
							</div>
							<div class="clearfix"> </div>
						</div>
					...
					<div class="form-group">
						<div class="row">
							<div class="col-md-12">
								GPA:
								<select name="GPA">
									<option value="0">No specific demand</option>
									<option value="3.0">3.0 Above</option>
									<option value="3.3">3.3 Above</option>
									<option value="3.5">3.5 Above</option>
									<option value="3.7">3.7 Above</option>
					...
					<div class="sub_home">
						<input type="submit" value="Push" name="pushsatisfied">
					</form>	
							<div class="clearfix"> </div>
					</div>
				</div>
