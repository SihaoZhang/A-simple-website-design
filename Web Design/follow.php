		...
		<div id="page-wrapper">
			<div class="main-page">
				...
				<div class="activity_box activity_box2">
					...
					$_SESSION['size_fol'] = $num;
					for($i = 1;$i <= $num;$i++){
						$row = mysqli_fetch_array($result);	
						 $_SESSION['com'.$i] = $row['cid'];
					?>			
						<div class="activity-row">
							...
							<div class="col-xs-6 activity-desc1"><h5><form action="stu_com.php" method="POST"><input type="submit" name="company<?php echo $i?>" value="more details"/></h5></div></form>
							<div class="col-xs-6 activity-desc1"><h5><form action="unfollow.php" method="POST"><input type = "submit" value= "Unfollow" name = "company<?php echo $i;?>"/></h5></div></form>
							<div class="clearfix"> </div>
						</div>
						<?php
				echo '</form>';
