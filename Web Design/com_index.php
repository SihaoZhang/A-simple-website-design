...
$sql="select jid, jtitle, count(sid) as total from application natural join job natural join company where cid='$nowid' group by jid,jtitle";
$rlt=sqlresult($sql) or die ("wrong");
					...
					?>
						...
						<div class="activity-row">
							...
							<div class="col-xs-5 activity-desc">
								...
								<p>number of applicants : <?php echo $row['total'];?></p>
							</div>
