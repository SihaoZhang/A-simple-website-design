...
$name=$row1['cname'];
	if(isset($_POST['submit'])){
		...
		if($cont==''){ 
			...
			header('refresh:2;url=com_index.php'); 
            exit;  
		}		
					...
					?>
						...
						<div class="activity-row">
							...
							<div class="col-xs-4 activity-desc">
								<h5><a href="#"><?php echo $row['jtitle'];?></a></h5>
								<p><?php echo $row['cname'];?></p>
							</div>
							<div class="col-xs-5 activity-desc1"><h5><form action="com_job.php" method="POST"><input type="submit" name="job<?php echo $i?>" value="more details"/></h5></div>
				...
				<div class="activity_box activity_box1">
					...
					?>			
						<div class="activity-row">
							...
							<div class="col-xs-5 activity-desc1"><h5><form action="com_com.php" method="POST"><input type="submit" name="company<?php echo $i?>" value="more details"/></h5></div></form>
				...
				$_SESSION['sid'.$i]=$row['sid'];
					?>			
						<div class="activity-row">
							...
							<div class="col-xs-5 activity-desc1"><h5><form action="com_stu.php" method="POST"><input type="submit" name="student<?php echo $i?>" value="more details"/></h5></div></form>
							<div class="clearfix"> </div>
						</div>
						<?php
				echo '</form>';
