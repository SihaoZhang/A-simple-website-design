...
$query2="SELECT * FROM student AS s where s.sid='$nowid'";
...
<body class="cbp-spmenu-push">
	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
      ...
      <nav class="navbar navbar-inverse">
		...
		<!-- //header-ends -->
		<?php
		$query1="SELECT * FROM company AS c where c.cid='$comid'";
		$result1=sqlresult($query1) or die('wrong');
		$row1=mysqli_fetch_array($result1);
		$_SESSION['comid'] = $row1['cid'];
		$comid = $row1['cid'];
		$query3 = "SELECT * FROM job AS j, company AS c WHERE j.cid = c.cid and c.cid = '$comid' and j.duedate >= NOW()";
		$result3 = sqlresult($query3);
		?>
			<div id="page-wrapper">
			<div class="main-page general">
				<h2 class="title1">Company Profile</h2>
				<div class="panel-info widget-shadow">
					<div class="col-md-6 panel-grids">
						<div class="panel panel-default"> <div class="panel-heading"> <h3 class="panel-title">Name</h3> </div> <div class="panel-body"><?php echo $row1['cname'];?></div> </div>
					</div>
					<div class="col-md-6 panel-grids">
						<div class="panel panel-primary"> <div class="panel-heading"> <h3 class="panel-title">Company number</h3> </div> <div class="panel-body"><?php echo $row1['cid'];?></div> </div>
					</div>
					<div class="col-md-6 panel-grids">
						<div class="panel panel-success"> <div class="panel-heading"> <h3 class="panel-title">Location</h3> </div> <div class="panel-body"><?php echo $row1['clocation'];?></div> </div>
					</div>
					<div class="col-md-6 panel-grids">
						<div class="panel panel-info"> <div class="panel-heading"> <h3 class="panel-title">Industry</h3> </div> <div class="panel-body"> <?php echo $row1['industry'];?></div> </div>
					</div>
					<div class="clearfix"> </div>
				</div>
					...
					?>
						...
						<div class="activity-row">
							<div class="col-xs-5 activity-desc">
								<h4><?php echo $row3['jtitle'];?></h4>
							</div>
							<div class="col-xs-6 activity-desc1"><form action="stujob_c.php" method="POST"><input type="submit" name="job<?php echo $i?>" value="More details"/></h5></div>
